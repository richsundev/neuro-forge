...
pytest (175 tests), mypy (strict), Ruff, ESLint, tsc.
...
make test              # 175 tests, mock mode, no external services, ~20s
...
[promotion](docs/promotion.md) · [security](docs/security.md) · [reproducibility](docs/reproducibility.md) ·
